      ...
      <div className="footer">
        <div className="footer-wrapper">
          ...
          <div className="footer-social">
            ...
            <p>
              ...
              <br></br>Cộng tác viên MobiFone với mức hoa hồng <br></br> hấp
              dẫn!
            </p>
        ...
        <div className="footer-copyright">
          <p>
            ...
            Tầng 7, Toà Nhà Đại Phát, số 82, Phố Duy Tân, Cầu Giấy, Hà Nội. |
            Điện thoại: +84-24-3568 2502 - Fax: +84-24-3568 2504
          </p>
        </div>
